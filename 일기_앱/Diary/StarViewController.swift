...
class StarViewController: UIViewController {
    ...
    @objc func starDiaryNotification(_ notification: Notification){
        ...
        if isStar{
            ...
            guard let index = self.diaryList.firstIndex(where: {$0.uuidString == uuidString}) else {return}//notification에서 전달받은 uuid와 같은값이 배열의 요소에 있는지 확인하고 있으면 해당 요소의 index 반환
